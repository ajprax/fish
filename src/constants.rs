...
pub const TIME_RATE: f32 = 120.0; // TODO: the time rate affects the relative scale of speed vs angles. it may be correct to multiply or divide some of those values as well
pub const NFISH: usize = 100;
pub const NSHARKS: usize = 0;
pub const FISH_SPEED: f32 = 1.25;
pub const SHARK_SPEED: f32 = 0.75;
pub const FLIGHT_MAX: f32 = 200.0; // TODO: consider making this a duration instead
